...
# 5. Start with an array of beach names and create a new array with only the beach names shorter than 7 letters. For example, ["Tumon", "Ypao", "Gun Beach", "Ritidian", "Tanguisson"] becomes ["Tumon", "Ypao"].